    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      {showSuccessModal && (
        <div style={{
          ...
          <div style={{
            ...
            textAlign: 'center', boxShadow: '0 20px 60px rgba(70, 52, 20, 0.15)'
          }}>
            ...
            <button
              ...
              style={{ padding: '0.7rem 2rem', fontSize: '0.9rem', display: 'block', margin: '0 auto', border: '1px solid rgba(42, 33, 24, 0.18)' }}
            >
              CONTINUAR
            </button>
          </div>
      ...
      <div style={{ width: '100%', alignSelf: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(450px, 100%), 1fr))', gap: '3rem', width: '100%' }}>
          ...
          alignItems: 'center',
          gap: '1rem',
          boxShadow: '0 10px 30px rgba(70, 52, 20, 0.1)'
        }}>
          <div
            style={{
              position: 'relative',
          ...
          <form onSubmit={handleUpdateEmail} style={{ display: 'flex', gap: '1rem', alignItems: 'flex-end', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: '200px' }}>
              <input
                ...
                style={{
                  width: '100%',
                  padding: '0.8rem 1rem',
                  background: isEditingEmail && !pendingEmailChange ? 'rgba(70, 52, 20, 0.1)' : 'rgba(42, 33, 24, 0.052)',
                  border: isEditingEmail && !pendingEmailChange ? '1px solid var(--gold-primary)' : '1px solid rgba(42, 33, 24, 0.18)',
                  borderRadius: '8px',
            ...
            {!isEditingEmail ? (
              <button
                ...
                className="btn-outline"
                style={{ padding: '0.8rem', height: '46px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(42, 33, 24, 0.18)', cursor: pendingEmailChange ? 'not-allowed' : 'pointer', opacity: pendingEmailChange ? 0.5 : 1 }}
              ...
              <>
                ...
                <button
                  ...
                  className="btn-outline"
                  style={{ padding: '0.8rem 1.5rem', height: '46px', border: '1px solid rgba(42, 33, 24, 0.18)', cursor: 'pointer' }}
                >
                  Cancelar
                </button>
              </>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '1rem' }}>
                {/* Streak */}
                <div style={{ background: 'rgba(70, 52, 20, 0.1)', padding: '1.5rem 1rem', borderRadius: '12px', border: '1px solid rgba(42, 33, 24, 0.052)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', textAlign: 'center' }}>
                ...
                {/* EPCoins */}
                <div style={{ background: 'rgba(70, 52, 20, 0.1)', padding: '1.5rem 1rem', borderRadius: '12px', border: '1px solid var(--gold-primary)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', textAlign: 'center' }}>
                ...
                {/* Simulador de Banca */}
                <div
                  style={{ background: 'rgba(70, 52, 20, 0.1)', padding: '1.5rem 1rem', borderRadius: '12px', border: '1px solid rgba(42, 33, 24, 0.052)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', textAlign: 'center' }}
                >
