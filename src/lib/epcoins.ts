...
const MENSAGENS: Record<string, string> = {
  ...
  NAO_ES_DONO: 'Só o líder do clã pode fazer isto.',
  UTILIZADOR_INEXISTENTE: 'Não há ninguém com esse nome de utilizador.',
  JA_TEM_CLA: 'Esse utilizador já pertence a um clã.',
  JA_CONVIDADO: 'Já convidaste esse utilizador.',
  CONVITE_INEXISTENTE: 'Este convite já não existe.',
